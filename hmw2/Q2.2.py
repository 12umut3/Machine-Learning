...
for i in range(0,5):
	...
	print 'accuracy of fold:',accuracy
	...
	Precision_each_fold.append(Precision)
	Recall_each_fold.append(Recall)


print "Precision of each fold :",Precision_each_fold
print "Recall of each fold :",Recall_each_fold
